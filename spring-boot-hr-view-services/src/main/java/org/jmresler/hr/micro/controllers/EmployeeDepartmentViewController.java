...
import org.jmresler.hr.micro.services.EmployeeDepartmentViewService;
...
public class EmployeeDepartmentViewController {
    ...
    @GetMapping(path = "/get-emp-dept-by-names-page/{pageNo}/{pageSize}",
            ...
            consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    public ResponseEntity<List<VEmployeeDepartment>> getEmployeeDepartmentViewsByFirstNameLastName(
            @ApiParam(name = "pageNo",
                    allowEmptyValue = false,
                    allowMultiple = false,
                    type = "java.lang.Integer >= 0")
